...
- 代码嵌入网页的方法
    - [script 元素嵌入代码](https://wangdoc.com/javascript/bom/engine.html#script-元素嵌入代码)
    - [script 元素加载外部脚本](https://wangdoc.com/javascript/bom/engine.html#script-元素加载外部脚本)
    - [事件属性](https://wangdoc.com/javascript/bom/engine.html#事件属性)
    - [URL 协议](https://wangdoc.com/javascript/bom/engine.html#url-协议)
- script 元素
    - [工作原理](https://wangdoc.com/javascript/bom/engine.html#工作原理)
    - [defer 属性](https://wangdoc.com/javascript/bom/engine.html#defer-属性)
    - [async 属性](https://wangdoc.com/javascript/bom/engine.html#async-属性)
    - [脚本的动态加载](https://wangdoc.com/javascript/bom/engine.html#脚本的动态加载)
    - [加载使用的协议](https://wangdoc.com/javascript/bom/engine.html#加载使用的协议)
- 浏览器的组成
    - [渲染引擎](https://wangdoc.com/javascript/bom/engine.html#渲染引擎)
    - [重流和重绘](https://wangdoc.com/javascript/bom/engine.html#重流和重绘)
    - [JavaScript 引擎](https://wangdoc.com/javascript/bom/engine.html#javascript-引擎)
- [参考链接](https://wangdoc.com/javascript/bom/engine.html#参考链接)
