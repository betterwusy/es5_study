...
- [Text 节点的概念](https://wangdoc.com/javascript/dom/text.html#text-节点的概念)
- Text 节点的属性
    - [data](https://wangdoc.com/javascript/dom/text.html#data)
    - [wholeText](https://wangdoc.com/javascript/dom/text.html#wholetext)
    - [length](https://wangdoc.com/javascript/dom/text.html#length)
    - [nextElementSibling，previousElementSibling](https://wangdoc.com/javascript/dom/text.html#nextelementsiblingpreviouselementsibling)
- Text 节点的方法
    - [appendData()，deleteData()，insertData()，replaceData()，subStringData()](https://wangdoc.com/javascript/dom/text.html#appenddatadeletedatainsertdatareplacedatasubstringdata)
    - [remove()](https://wangdoc.com/javascript/dom/text.html#remove)
    - [splitText()](https://wangdoc.com/javascript/dom/text.html#splittext)
- [DocumentFragment 节点](https://wangdoc.com/javascript/dom/text.html#documentfragment-节点)
